...
description: "From zero to your first digest in 5 minutes"
---

# Quick Start Guide

**From zero to your first digest in 5 minutes**
...
**Forward a message** - Just forward any message from a channel you want to track. We'll grab the channel automatically.

**Paste the username** - Send us the channel's @ handle (like @somechannel) or the full t.me link.
...
- **Global Market View** - Macro news, regulations, institutional moves
- **Exchange Promos** - Listings, campaigns, trading competitions
- **Summaries** - Multi-topic digests
- **IDO** - Token launches and sales

Pick as many or as few as you want. You can always change this later in settings.
...
<Tip>
**Don't pick all categories.** The point is to filter. If you select everything, you're back to information overload.
</Tip>
...
Something broken? Feature missing? Tell us - beta exists so you can shape what we build.

<CardGroup cols={2}>
  <Card title="Community" icon="users" href="https://t.me/alphatrack_ann">
    Join our Telegram channel
  </Card>
  <Card title="Support" icon="comments" href="https://t.me/alphatrack_official">
